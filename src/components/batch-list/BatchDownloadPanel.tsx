import { Button, Card, Typography, Tag, Progress, Badge } from 'antd';
import { 
  PlayCircleOutlined, 
  PauseCircleOutlined, 
  StopOutlined, 
...
export const BatchDownloadPanel: React.FC<BatchDownloadPanelProps> = ({ list }) => {
  const {
    progress,
    handleBatchDownload,
    pauseBatchDownload,
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <Text style={{ color: 'rgba(255,255,255,0.8)' }}>
                {list.accounts.length} 个账户 · {list.filter.mediaTypes.length} 种媒体
              </Text>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Badge 
              ...
              text={<span className="text-white text-sm font-medium">
      ...
      <div className="px-6 py-5 bg-white/10 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-4 gap-4 mb-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-white">{list.accounts.length}</div>
        ...
        <div className="mb-3">
          {currentAccount && (
            <div className="flex items-center gap-2 text-white/80">
              ...
              <Tag color="yellow" className="text-sm">@{currentAccount}</Tag>
              <span className="text-sm">({currentIndex + 1}/{list.accounts.length})</span>
            </div>
          )}
        </div>
          ...
          {completedAccounts.length > 0 && (
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Text strong className="text-white text-sm">已完成</Text>
          ...
          {failedAccounts.length > 0 && (
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Text strong className="text-white text-sm">失败</Text>
